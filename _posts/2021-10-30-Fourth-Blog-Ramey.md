...
'polarized' was a function in R.  I was interpretting the word as a laymen and thinking it was 'Polarized Viewpoints'.  
...
carts (you know it had to be an article about cats).
...
some fanagaling, but I had immediate feedback on my code.  Compiling the Random Forest took ages and required parallel processing. I had enough trouble
...
Also, I am appreciating more an more what programming can do.  The 'labor pains' of navagating Markdown, of learning R packages (such as caret, gbm, etc),
